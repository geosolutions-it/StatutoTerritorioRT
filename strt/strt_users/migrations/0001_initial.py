    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('COMUNE', 'COMUNE'), ('REGIONE', 'REGIONE'), ('ALTRO', 'ALTRO')], max_length=16)),
            ],
            options={
                'verbose_name': 'ente',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profilo', models.CharField(choices=[('ADMIN_PORTALE', 'ADMIN_PORTALE'), ('RESP_RUP', 'RESP_RUP'), ('ADMIN_ENTE', 'ADMIN_ENTE'), ('OPERATORE', 'OPERATORE')], max_length=21)),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(check=models.Q(models.Q(_negated=True, profilo=strt_users.enums.Profilo('ADMIN_PORTALE')), models.Q(('profilo', strt_users.enums.Profilo('ADMIN_PORTALE')), ('ente__isnull', True)), _connector='OR'), name='No ENTE for global admins'),
        ),
        migrations.AddConstraint(
            model_name='profiloutente',
            constraint=models.CheckConstraint(check=models.Q(('profilo', strt_users.enums.Profilo('ADMIN_PORTALE')), models.Q(models.Q(_negated=True, profilo=strt_users.enums.Profilo('ADMIN_PORTALE')), ('ente__isnull', False)), _connector='OR'), name='ENTE required for non-admins'),
        ),
    ]
