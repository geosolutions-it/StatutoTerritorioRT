...
class DataLoader:
    ...
    UFF_ETJ_PIA = 'Ufficio ETJ Paesaggio'
    ...
    UFF_ALL_PIA = 'Ufficio G.All. Paesaggio'
    ...
    utenti = [
        ...
        {'fiscal_code': FC_ETJ_PIA, 'first_name': 'Emanuele', 'last_name': 'Paesano', 'email': ETJ_MAIL},
        ...
        {'fiscal_code': FC_ALL_PIA, 'first_name': 'Giovanni', 'last_name': 'Paesano', 'email': ALL_MAIL},
    ...
    qu_to_store = [
        ...
        (IPA_RT, UFF_PIAN, [Qualifica.OPREG], {
            FC_PIAN: [Qualifica.OPREG],
        }),
        ...
        (IPA_RT, UFF_ETJ_PIA, [Qualifica.OPREG], {
            FC_ETJ_PIA: [Qualifica.OPREG],
            FC_ALL_PIA: [Qualifica.OPREG],
        }),
        (IPA_RT, UFF_ETJ_URB, [Qualifica.OPREG], {
            FC_ETJ_URB: [Qualifica.OPREG],
            FC_ALL_URB: [Qualifica.OPREG],
        }),
        ...
        (IPA_RT, UFF_ALL_PIA, [Qualifica.OPREG], {
            FC_ETJ_PIA: [Qualifica.OPREG],
            FC_ALL_PIA: [Qualifica.OPREG],
        }),
        (IPA_RT, UFF_ALL_URB, [Qualifica.OPREG], {
            FC_ETJ_URB: [Qualifica.OPREG],
            FC_ALL_URB: [Qualifica.OPREG],
        }),
