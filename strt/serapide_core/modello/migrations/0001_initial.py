    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qualifica_richiesta', models.CharField(choices=[('COMUNE', 'Responsabile Comunale'), ('AC', 'AC'), ('SCA', 'SCA'), ('GC', 'Genio Civile'), ('PIAN', 'Responsabile Pianificazione'), ('URB', 'Responsabile Urbanistica'), ('REGIONE', 'Responsabile Regionale')], max_length=26)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('qualifica', models.CharField(choices=[('RESP', 'RESP'), ('AC', 'AC'), ('SCA', 'SCA'), ('GC', 'GENIO_CIVILE'), ('PIAN', 'PIANIFICAZIONE'), ('URB', 'URBANISTICA'), ('READONLY', 'READONLY')], max_length=18)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fase', models.CharField(choices=[('UNKNOWN', 'UNKNOWN'), ('DRAFT', 'DRAFT'), ('ANAGRAFICA', 'ANAGRAFICA'), ('AVVIO', 'AVVIO'), ('ADOZIONE', 'ADOZIONE'), ('APPROVAZIONE', 'APPROVAZIONE'), ('PUBBLICAZIONE', 'PUBBLICAZIONE')], default=serapide_core.modello.enums.Fase('UNKNOWN'), max_length=18)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipologia', models.CharField(choices=[('UNKNOWN', 'UNKNOWN'), ('OPERATIVO', 'OPERATIVO'), ('STRUTTURALE', 'STRUTTURALE'), ('VARIANTE_OPERATIVO', 'VARIANTE_OPERATIVO'), ('VARIANTE_STRUTTURALE', 'VARIANTE_STRUTTURALE')], default=serapide_core.modello.enums.TipologiaPiano('UNKNOWN'), max_length=35)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, null=True)),
                ('conferenza_copianificazione', models.CharField(blank=True, choices=[('POSTICIPATA', 'posticipata'), ('NECESSARIA', 'necessaria'), ('NON_NECESSARIA', 'non_necessaria')], default=None, max_length=40, null=True)),
                ('data_creazione', models.DateTimeField(auto_now_add=True)),
                ('data_scadenza_risposta', models.DateTimeField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, null=True)),
                ('tipologia', models.CharField(choices=[('UNKNOWN', 'UNKNOWN'), ('SEMPLIFICATA', 'SEMPLIFICATA'), ('VERIFICA', 'VERIFICA'), ('PROCEDIMENTO', 'PROCEDIMENTO'), ('PROCEDIMENTO_SEMPLIFICATO', 'PROCEDIMENTO_SEMPLIFICATO'), ('NON_NECESSARIA', 'NON_NECESSARIA')], default=serapide_core.modello.enums.TipologiaVAS('UNKNOWN'), max_length=38)),
