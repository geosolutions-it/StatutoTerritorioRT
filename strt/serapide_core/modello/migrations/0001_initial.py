    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipologia', models.CharField(choices=[(serapide_core.modello.enums.TipologiaPiano('UNKNOWN'), 'UNKNOWN'), (serapide_core.modello.enums.TipologiaPiano('OPERATIVO'), 'OPERATIVO'), (serapide_core.modello.enums.TipologiaPiano('STRUTTURALE'), 'STRUTTURALE'), (serapide_core.modello.enums.TipologiaPiano('VARIANTE_OPERATIVO'), 'VARIANTE_OPERATIVO'), (serapide_core.modello.enums.TipologiaPiano('VARIANTE_STRUTTURALE'), 'VARIANTE_STRUTTURALE')], default=serapide_core.modello.enums.TipologiaPiano('UNKNOWN'), max_length=35)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, null=True)),
                ('conferenza_copianificazione', models.CharField(blank=True, choices=[(serapide_core.modello.enums.TipologiaCopianificazione('posticipata'), 'posticipata'), (serapide_core.modello.enums.TipologiaCopianificazione('necessaria'), 'necessaria'), (serapide_core.modello.enums.TipologiaCopianificazione('non_necessaria'), 'non_necessaria')], default=None, max_length=40, null=True)),
                ('data_creazione', models.DateTimeField(auto_now_add=True)),
                ('data_scadenza_risposta', models.DateTimeField(blank=True, null=True)),
