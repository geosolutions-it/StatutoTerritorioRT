        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qualifica_richiesta', models.CharField(
                    choices=[
                        (strt_users.enums.QualificaRichiesta('Responsabile Comunale'), 'Responsabile Comunale'),
                        (strt_users.enums.QualificaRichiesta('AC'), 'AC'),
                        (strt_users.enums.QualificaRichiesta('SCA'), 'SCA'),
                        (strt_users.enums.QualificaRichiesta('Genio Civile'), 'Genio Civile'),
                        # (strt_users.enums.QualificaRichiesta('Responsabile Pianificazione'), 'Responsabile Pianificazione'),
                        # (strt_users.enums.QualificaRichiesta('Responsabile Urbanistica'), 'Responsabile Urbanistica'),
                        (strt_users.enums.QualificaRichiesta('Responsabile Regionale'), 'Responsabile Regionale'),
                        (strt_users.enums.QualificaRichiesta('Sistema'), 'Sistema')],
                    max_length=26)),
